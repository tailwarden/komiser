...
Below are the available downloads for the latest version of Komiser (2.8.1). Please download the proper package for your operating system and architecture.

### Linux:

```
wget https://cli.komiser.io/2.8.1/linux/komiser
```

### Windows:

```
wget https://cli.komiser.io/2.8.1/windows/komiser -OutFile komiser.exe
```

### Mac OS X:

```
wget https://cli.komiser.io/2.8.1/osx/komiser
```
...
```
docker run -d -p 3000:3000 -e AWS_ACCESS_KEY_ID="" -e AWS_SECRET_ACCESS_KEY="" -e AWS_DEFAULT_REGION="" --name komiser mlabouardy/komiser:2.8.1
```
