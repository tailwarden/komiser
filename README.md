...
Connect a local deployment of Komiser CLI to you r[**Digital Ocean**](https://docs.komiser.io/docs/Cloud%20Providers/digital-ocean?utm_source=github&utm_medium=social) account.
