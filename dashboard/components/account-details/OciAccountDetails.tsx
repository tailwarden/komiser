...
import { OCICredentials } from '@utils/cloudAccountHelpers';
...
interface OciAccountDetailsProps {
  cloudAccountData?: CloudAccountPayload<OCICredentials>;
  hasError?: boolean;
}

function OciAccountDetails({
  cloudAccountData,
  hasError = false
}: OciAccountDetailsProps) {
...
export default OciAccountDetails;
