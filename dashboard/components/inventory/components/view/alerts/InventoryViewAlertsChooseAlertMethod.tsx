    ...
    return (
        <div className="flex flex-col gap-4">
            <div
                ...
                className="flex cursor-pointer items-center gap-2 self-start text-black-900 text-sm"
            >
            ...
            {webhookOptions?.map((alert) => (
                <div key={alert.id}>
                    <div
                        ...
                        ${alert.id === AlertMethod.SLACK && !isSlackConfigured ? 'bg-gray-200 pointer-events-none' : ''
                            }`}
                    >
                    ...
                    {alert.id === AlertMethod.SLACK && !isSlackConfigured && (
                        <div className="mt-2">
                            <p className="text-xs text-black-400">
                                You have not set up your Slack integration. Learn how through our{" "}
                                <a
