...
export class OvhComputeComponent implements OnInit {
    ...
    constructor(private ovhService: OvhService) {
        this.ovhService.getCloudInstances().subscribe(
            (data) => {
                ...
                data.forEach((instance) => {
                    ...
                    machineTypes[instance.planCode] =
                        (machineTypes[instance.planCode]
                            ? machineTypes[instance.planCode]
                            : 0) + 1;
                });
        ...
        this.ovhService.getCloudImages().subscribe(
            (data) => {
        ...
        this.ovhService.getKubeClusters().subscribe(
            (data) => {
        ...
        this.ovhService.getKubeNodes().subscribe(
            (data) => {
