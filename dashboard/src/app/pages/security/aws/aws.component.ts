...
export class AwsSecurityComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    private initState() {
        this.awsService.getKMSKeys().subscribe(
            (data) => {
                this.kmsKeys = data;
        ...
        this.awsService.getSecurityGroups().subscribe(
            (data) => {
        ...
        this.awsService.getKeyPairs().subscribe(
            (data) => {
                this.keyPairs = data;
        ...
        this.awsService.getACMListCertificates().subscribe(
            (data) => {
        ...
        this.awsService.getACMExpiredCertificates().subscribe(
            (data) => {
        ...
        this.awsService.getUnrestrictedSecurityGroups().subscribe(
            (data) => {
                this.unrestrictedSecurityGroups = data;
                this.returnedUnrestrictedSecurityGroups =
                    this.unrestrictedSecurityGroups.slice(0, 20);
            },
            (err) => {
        ...
        this.awsService.getConsoleLoginEvents().subscribe(
            (data) => {
                let labels = [];
                let series = [];
        ...
        this.awsService.getConsoleLoginSourceIps().subscribe(
            (data) => {
                let plots = {};
                Object.keys(data).forEach((ip) => {
                    ...
                    plots[ip] = {
                        ...
                        tooltip: {
                            content: `${ip}<br />Total: ${data[ip].total}`,
                        },
                    };
                });
    ...
    pageChanged(event: PageChangedEvent): void {
        ...
        this.returnedUnrestrictedSecurityGroups =
            this.unrestrictedSecurityGroups.slice(startItem, endItem);
    }
    ...
    private showSignInEvents(labels, series) {
        this.signInEventsChart = new Chartist.Bar(
            '#signInEventsChart',
            {
                labels: labels,
                series: series,
