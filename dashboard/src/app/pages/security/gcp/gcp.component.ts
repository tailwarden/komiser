...
export class GcpSecurityComponent implements OnInit {
    ...
    constructor(private gcpService: GcpService) {
        this.gcpService.getIamRoles().subscribe(
            (data) => {
                this.iamRoles = data;
        ...
        this.gcpService.getVPNTunnels().subscribe(
            (data) => {
        ...
        this.gcpService.getVpcFirewalls().subscribe(
            (data) => {
                this.firewalls = data;
        ...
        this.gcpService.getSSLCertificates().subscribe(
            (data) => {
        ...
        this.gcpService.getSSLPolicies().subscribe(
            (data) => {
        ...
        this.gcpService.getSecurityPolicies().subscribe(
            (data) => {
        ...
        this.gcpService.getKMSCryptoKeys().subscribe(
            (data) => {
        ...
        this.gcpService.getEnabledAPIs().subscribe(
            (data) => {
        ...
        this.gcpService.getServiceAccounts().subscribe(
            (data) => {
