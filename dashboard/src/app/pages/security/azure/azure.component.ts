...
export class AzureSecurityComponent implements OnInit, OnDestroy {
    ...
    private initState() {
        ...
        this.azureService.getFirewalls().subscribe(
            (data) => {
                this.firewalls = data;
        ...
        this.azureService.getCertificates().subscribe(
            (data) => {
        ...
        this.azureService.getExpiredCertificates().subscribe(
            (data) => {
        ...
        this.azureService.getProfiles().subscribe(
            (data) => {
                this.profiles = data;
        ...
        this.azureService.getSecurityGroups().subscribe(
            (data) => {
        ...
        this.azureService.getSecurityRules().subscribe(
            (data) => {
