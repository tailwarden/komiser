...
export class GcpDataAndAIComponent implements OnInit {
    ...
    constructor(private gcpService: GcpService) {
        this.gcpService.getPubSubTopics().subscribe(
            (data) => {
        ...
        this.gcpService.getBigQueryStatements().subscribe(
            (data) => {
        ...
        this.gcpService.getBigQueryStorage().subscribe(
            (data) => {
                ...
                this.bigquerySize = this.bytesToSizeWithUnit(
                    total * 1024 * 1024
                );
        ...
        this.gcpService.getBigQueryDatasets().subscribe(
            (data) => {
        ...
        this.gcpService.getBigQueryTables().subscribe(
            (data) => {
        ...
        this.gcpService.getDataprocClusters().subscribe(
            (data) => {
        ...
        this.gcpService.getDataprocJobs().subscribe(
            (data) => {
        ...
        this.gcpService.getDataflowJobs().subscribe(
            (data) => {
