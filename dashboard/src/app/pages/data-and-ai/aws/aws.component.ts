...
export class AwsDataAndAIComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    private initState() {
        this.awsService.getSQSPublishedMessagesMetrics().subscribe(
            (data) => {
                this.numberOfMessagesSentToday =
                    data[0].Datapoints[
                        Object.keys(data[0].Datapoints)[
                            Object.keys(data[0].Datapoints).length - 1
                        ]
                    ];
                this.numberOfMessagesDeletedToday =
                    data[1].Datapoints[
                        Object.keys(data[1].Datapoints)[
                            Object.keys(data[1].Datapoints).length - 1
                        ]
                    ];
                ...
                this.showSQSMessages(labels, [seriesSent, seriesDeleted]);
            },
            (err) => {
                this.loadingSQSMessagesChart = false;
                this.loadingSQSMessages = false;
        ...
        this.awsService.getSQSQueues().subscribe(
            (data) => {
                this.sqsQueues = data;
        ...
        this.awsService.getSNSTopics().subscribe(
            (data) => {
                this.snsTopics = data;
        ...
        this.awsService.getActiveMQBrokers().subscribe(
            (data) => {
        ...
        this.awsService.getKinesisShards().subscribe(
            (data) => {
        ...
        this.awsService.getKinesisStreams().subscribe(
            (data) => {
        ...
        this.awsService.getGlueCrawlers().subscribe(
            (data) => {
        ...
        this.awsService.getGlueJobs().subscribe(
            (data) => {
                this.glueJobs = data;
        ...
        this.awsService.getDataPipelines().subscribe(
            (data) => {
        ...
        this.awsService.getESDomains().subscribe(
            (data) => {
                this.esDomains = data;
        ...
        this.awsService.getSWFDomains().subscribe(
            (data) => {
    ...
    private showSQSMessages(labels, series) {
        let scope = this;
        this.sqsMessagesChart = new Chartist.Bar(
            '#sqsMessagesChart',
            {
                labels: labels,
                series: series,
