...
export class AwsStorageComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    private initState() {
        this.awsService.getNumberOfS3Buckets().subscribe(
            (data) => {
        ...
        this.awsService.getEBS().subscribe(
            (data) => {
                let sum = 0;
                let labels = [];
                let series = [];
                ...
                this.ebsTotalSize = this.bytesToSizeWithUnit(
        ...
        this.awsService.getBucketObjects().subscribe(
            (data) => {
                let total = 0;
                    ...
                    total +=
                        data[region][
                            Object.keys(data[region])[
                                Object.keys(data[region]).length - 1
                            ]
                        ];
                });
        ...
        this.awsService.getGlacierVaults().subscribe(
            (data) => {
                this.loadingGlacier = false;
                this.glacierVaults = data['vaults'];
                this.glacierVaultsSize = this.bytesToSizeWithUnit(
        ...
        this.awsService.getBucketSize().subscribe(
            (data) => {
                let labels = [];
                let i = 0;
                let series = [];
        ...
        this.awsService.getEmptyBuckets().subscribe(
            (data) => {
        ...
        this.awsService.getDynamoDBTables().subscribe(
            (data) => {
        ...
        this.awsService.getRDSInstances().subscribe(
            (data) => {
        ...
        this.awsService.getElasticacheClusters().subscribe(
            (data) => {
                this.redisClusters = data['redis'] ? data['redis'] : 0;
                this.memcachedClusters = data['memcached']
                    ? data['memcached']
                    : 0;
        ...
        this.awsService.getLogsVolume().subscribe(
            (data) => {
        ...
        this.awsService.getLogsRetentionPeriod().subscribe(
            (data) => {
        ...
        this.awsService.getRedshiftClusters().subscribe(
            (data) => {
    ...
    private showS3BucketsObjects(labels, series) {
        let scope = this;
        this.s3BucketsObjectsChart = new Chartist.Bar(
            '#s3BucketsObjectsChart',
            {
                labels: labels,
                series: series,
            },
    ...
    private showS3BucketsSize(labels, series) {
        let scope = this;
        this.s3BucketsSizeChart = new Chartist.Bar(
            '#s3BucketsSizeChart',
            {
                labels: labels,
                series: series,
    ...
    private showLogsVolume(labels, series) {
        let scope = this;
        this.logsVolumeChart = new Chartist.Bar(
            '#logsVolumeChart',
            {
                labels: labels,
                series: series,
