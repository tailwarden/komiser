...
export class AzureStorageComponent implements OnInit, OnDestroy {
    ...
    private initState() {
        ...
        this.azureService.getSnapshots().subscribe(
            (data) => {
        ...
        this.azureService.getDisks().subscribe(
            (data) => {
                ...
                this.disksSize = this.bytesToSizeWithUnit(
                    total * 1024 * 1024 * 1024
                );
        ...
        this.azureService.getMySQLs().subscribe(
            (data) => {
        ...
        this.azureService.getPostgreSQLs().subscribe(
            (data) => {
        ...
        this.azureService.getRedisInstances().subscribe(
            (data) => {
