...
export class AwsNetworkComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    private initState() {
        this.awsService.getVirtualPrivateClouds().subscribe(
            (data) => {
                this.vpcNumber = data;
        ...
        this.awsService.getAccessControlLists().subscribe(
            (data) => {
                this.aclNumber = data;
        ...
        this.awsService.getRouteTables().subscribe(
            (data) => {
        ...
        this.awsService.getCloudFrontDistributions().subscribe(
            (data) => {
        ...
        this.awsService.getCloudFrontRequests().subscribe(
            (data) => {
                let datasets = [];
                let total = 0;
                ...
                this.cdnYesterdayRequests =
                    this.formatNumber(yesterdayRequests).toString();
                this.cdnTodayRequests =
                    this.formatNumber(todayRequests).toString();
        ...
        this.awsService.getApiGatewayRequests().subscribe(
            (data) => {
                let datasets = [];
                let total = 0;
                ...
                this.apigatewayYesterdayRequests =
                    this.formatNumber(yesterdayRequests).toString();
                this.apigatewayTodayRequests =
                    this.formatNumber(todayRequests).toString();
        ...
        this.awsService.getApiGatewayRestAPIs().subscribe(
            (data) => {
        ...
        this.awsService.getELBRequests().subscribe(
            (data) => {
                let datasets = [];
                let total = 0;
                ...
                this.elbYesterdayRequests =
                    this.formatNumber(yesterdayRequests).toString();
                this.elbTodayRequests =
                    this.formatNumber(todayRequests).toString();
        ...
        this.awsService.getELBFamily().subscribe(
            (data) => {
                let labels = [];
                let dataset = [];
                let total = 0;
        ...
        this.awsService.getRoute53Records().subscribe(
            (data) => {
        ...
        this.awsService.getRoute53Zones().subscribe(
            (data) => {
        ...
        this.awsService.getNatGatewayTraffic().subscribe(
            (data) => {
                ...
                if (this.natGatewayAvailableRegions.length > 0) {
                    this.showNatGatewayTrafficInRegion(
                        this.natGatewayAvailableRegions[0]
                    );
                }
        ...
        this.awsService.getVPCSubnets().subscribe(
            (data) => {
    ...
    private showNatGatewayTraffic(labels, series) {
        let scope = this;
        this.natGatewayChartTraffic = new Chartist.Bar(
            '#natGatewayChartTraffic',
            {
                labels: labels,
                series: series,
            },
    ...
    public showNatGatewayTrafficInRegion(region: any) {
        ...
        Object.keys(this.natGatewayTraffic[region]).forEach((timestamp) => {
            ...
            serieBytesIn.push({
                meta: 'BytesInFromDestination',
                value: this.natGatewayTraffic[region][timestamp]
                    .BytesInFromDestination,
            });
            serieBytesOut.push({
                meta: 'BytesOutToDestination',
                value: this.natGatewayTraffic[region][timestamp]
