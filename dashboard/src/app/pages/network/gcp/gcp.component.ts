...
export class GcpNetworkComponent implements OnInit {
    ...
    constructor(private gcpService: GcpService) {
        this.gcpService.getDNSZones().subscribe(
            (data) => {
                this.dnsZones = data;
        ...
        this.gcpService.getVpcNetworks().subscribe(
            (data) => {
                this.networks = data;
        ...
        this.gcpService.getVpcRouters().subscribe(
            (data) => {
                this.routers = data;
        ...
        this.gcpService.getLBRequests().subscribe(
            (data) => {
        ...
        this.gcpService.getAPIRequests().subscribe(
            (data) => {
                let availablePeriods = [];
                data.forEach((resource) => {
                    resource.points.forEach((point) => {
        ...
        this.gcpService.getTotalLoadBalancers().subscribe(
            (data) => {
        ...
        this.gcpService.getVPCSubnets().subscribe(
            (data) => {
                this.subnets = data;
        ...
        this.gcpService.getVPCAddresses().subscribe(
            (data) => {
        ...
        this.gcpService.getDnsARecords().subscribe(
            (data) => {
                this.aRecords = data;
        ...
        this.gcpService.getNatGateways().subscribe(
            (data) => {
