...
export class OvhNetworkComponent implements OnInit {
    ...
    constructor(private ovhService: OvhService) {
        this.ovhService.getCloudIps().subscribe(
            (data) => {
                this.cloudIps = data;
        ...
        this.ovhService.getPublicNetworks().subscribe(
            (data) => {
        ...
        this.ovhService.getPrivateNetworks().subscribe(
            (data) => {
        ...
        this.ovhService.getFailoverIps().subscribe(
            (data) => {
        ...
        this.ovhService.getVRacks().subscribe(
            (data) => {
                this.vRacks = data;
