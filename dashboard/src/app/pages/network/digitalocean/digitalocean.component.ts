...
export class DigitaloceanNetworkComponent implements OnInit, OnDestroy {
    ...
    private initState() {
        ...
        this.digitaloceanService.getFloatingIps().subscribe(
            (data) => {
        ...
        this.digitaloceanService.getDomains().subscribe(
            (data) => {
                this.domains = data;
        ...
        this.digitaloceanService.getLoadBalancers().subscribe(
            (data) => {
        ...
        this.digitaloceanService.getContentDeliveryNetworks().subscribe(
            (data) => {
        ...
        this.digitaloceanService.getRecords().subscribe(
            (data) => {
