...
export class DigitaloceanDashboardComponent
    implements OnInit, AfterViewInit, OnDestroy
{
    ...
    private initState() {
        ...
        this.digitaloceanService.getProjects().subscribe(
            (data) => {
                this.projects = data;
        ...
        this.digitaloceanService.getDroplets().subscribe(
            (data) => {
                ...
                data.forEach((droplet) => {
                    let region = droplet.region.substring(
                        0,
                        droplet.region.length - 1
                    );
                    _usedRegions[region] =
