...
export class AzureNetworkComponent implements OnInit, OnDestroy {
  ...
  private initState() {
    ...
    this.azureService.getLoadBalancers().subscribe(data => {
    ...
    this.azureService.getRouteTables().subscribe(data => {
    ...
    this.azureService.getSubnets().subscribe(data => {
      this.subnets = data;
    ...
    this.azureService.getDNSZones().subscribe(data => {
      this.dnsZones = data;
